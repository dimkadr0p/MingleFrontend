    ...
    return (
        <div className="relative">
            <button
                ...
                className="fixed z-10 top-4 left-4 p-2 ml-32 mt-2 rounded-md bg-slate-100 text-black"
            >
            ...
            {isOpen && (
                <div ref={menuRef} className="fixed z-10 top-0 left-0 w-60 h-full bg-slate-200 text-black p-4 border">
                    ...
                    <div className='flex mb-4 hover:bg-slate-300 rounded-md'>
                        ...
                        <button className="block ml-4">Настройки</button>
                    </div>
                    ...
                    <div className='flex mb-4 hover:bg-slate-300 rounded-md'>
                        ...
                        <button onClick={() => { localStorage.removeItem("token"); window.location.reload() }} className="block ml-4">Выход</button>
                    </div>

                </div>
            )}

            <ProfileCenteredModal
                show={modalShowProfile}
                onHide={() => setModalShowProfile(false)}
            />

            <ContactsCenteredModal
